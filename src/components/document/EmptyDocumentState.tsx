    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center min-h-[600px] animate-fade-in p-6">
            <div className="relative mb-8">
                ...
                <div className="absolute inset-0 bg-[#00E5BC]/20 blur-[80px] rounded-full" />
                ...
                <div className="relative w-24 h-24 bg-secondary/30 rounded-3xl border border-border/50 flex items-center justify-center backdrop-blur-sm">
                    ...
                    <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-[#00E5BC] rounded-xl flex items-center justify-center shadow-lg shadow-[#00E5BC]/30 animate-bounce-slow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 w-full max-w-3xl">
                <div className="glass-panel p-5 flex flex-col items-center text-center group hover:border-[#00E5BC]/30 transition-all duration-300">
                    <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center mb-4 text-[#00E5BC] group-hover:scale-110 transition-transform">
            ...
            <Button
                ...
                size="lg"
                className="h-14 px-10 rounded-2xl bg-[#00E5BC] text-background hover:scale-[1.02] active:scale-[0.98] transition-all font-bold text-base shadow-xl shadow-[#00E5BC]/20 gap-3"
            >
                <Upload className="w-5 h-5" />
                Upload Document
            </Button>
